...
<main class="w3-container" style="margin-top: 20px;">
  <h2 style="margin-bottom: 20px;" class="w3-center">Últimes Notícies</h2>
  ...
  <div class="w3-container moreNews">
    <a href="pages/noticies.html" class="w3-button w3-blue w3-round">MÉS NOTÍCIES</a>
  </div>
</main>
