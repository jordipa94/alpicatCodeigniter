...
<body>
    <div class="login-container" id="loginContainer">
        ...
        <form action="<?php echo base_url('registrar_post') ?>" method="POST">
            ...
            <div class="form-group">
                <input type="tel" class="input-field" id="Telf" placeholder="Telefono" required />
            </div>
        ...
        <button type="button" class="submit-btn" id="backBtn">Volver</button>
    </div>
    ...
    <script>
        document.getElementById('backBtn').addEventListener('click', function() {
            ...
            setTimeout(() => {
                window.location.href = "<?php echo base_url('/administracio_log'); ?>";
